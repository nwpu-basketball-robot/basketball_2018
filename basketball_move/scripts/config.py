...
robot_state_pkg_path = '/home/marilyn/my_workspace/src/robot_move_pkg/scripts/'
...
high_turn_angular_speed = 0.6


# 低速、在机器人坐标系下转动速度
low_turn_angular_speed = 0.55
#弧度值 代表高速停止的阈值
...
go_along_circle_speed = 0.8
go_along_circle_angular_tolerance =  0.08
